 ...
 */
@Entity
@Table(name = "ZcbPcbRelationEntity")
public class ZcbPcbRelationEntity extends BaseEntity {

  @Column(name = "zcb_number")
  private String ZCB_NUMBER;
  ...
  @Column(name = "zcb_item")
  private String ZCB_ITEM;
  @Column(name = "pcb_item")
  private String PCB_ITEM;
  ...
  public String getZCB_NUMBER() {
    return ZCB_NUMBER;
  }

  public void setZCB_NUMBER(String ZCB_NUMBER) {
    this.ZCB_NUMBER = ZCB_NUMBER;
  }
  ...
  public String getZCB_ITEM() {
    return ZCB_ITEM;
  }

  public void setZCB_ITEM(String ZCB_ITEM) {
    this.ZCB_ITEM = ZCB_ITEM;
  }

  public String getPCB_ITEM() {
    return PCB_ITEM;
  }

  public void setPCB_ITEM(String PCB_ITEM) {
    this.PCB_ITEM = PCB_ITEM;
  }
